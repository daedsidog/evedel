...
| Custom Variable                        | Variable Description                                       |
|----------------------------------------+------------------------------------------------------------|
| =evedel-directives-inherit-commentary= | Controls if child directives inherit ancestral commentary. |
| =evedel-references-inherit-commentary= | Controls if child references inherit ancestral commentary. |
